...
// //  */
var favColor = prompt("What is you favorite color?").toLowerCase();
...
if(enterNumber === true) {
    ...
    if (isNumeric(number)) {
        alert(createEvenOddMessage(number));
        alert(createNumberPlus100Message(number));
        alert(createNegativePositiveMessage(number));
    } else {
